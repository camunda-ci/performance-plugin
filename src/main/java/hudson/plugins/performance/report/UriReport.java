 ...
 */
public class UriReport extends AbstractHttpReport implements Comparable<UriReport> {
  ...
  public void addHttpSample(HttpPerformanceReportSample sample) {
  ...
  protected long getDurationAt(double percentage) {
  ...
  public void doSummarizerTrendGraph(StaplerRequest request,StaplerResponse response) throws IOException {    
    ...
    ChartUtil.generateGraph(request, response, PerformanceProjectAction.createSummarizerTrend(dataset, uri),400, 200);
  }
