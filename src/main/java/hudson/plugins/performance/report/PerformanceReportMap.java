...
public class PerformanceReportMap implements ModelObject {
  ...
  protected void parseReports(AbstractBuild<?, ?> build, TaskListener listener, PerformanceReportCollector collector, final String filename) throws IOException {
  ...
  public Object createTrendReportGraphs(final StaplerRequest request) {
    ...
    TrendReportGraphs trendReport = new TrendReportGraphs(build.getProject(), build, request, filename, report);
