...
public abstract class PerformanceReportParser implements Describable<PerformanceReportParser>, ExtensionPoint {
   ...
   */
  public abstract Collection<PerformanceReport> parse(AbstractBuild<?, ?> build, Collection<File> reports, TaskListener listener) throws IOException;

  public abstract String getDefaultGlobPattern();

  /**
   * All registered {@link PerformanceReportParser} implementations.
   */
