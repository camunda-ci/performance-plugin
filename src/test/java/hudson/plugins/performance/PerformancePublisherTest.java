...
import hudson.plugins.performance.parser.JUnitParser;
 ...
 */
  public class PerformancePublisherTest extends HudsonTestCase {
    ...
    public void testConfigRoundtrip() throws Exception {
        PerformancePublisher before = new PerformancePublisher(10, 20, "",
            0, 0, 0, 0,
            PerformancePublisher.BUILD_MODE_LSB, null,
            0, false, PerformancePublisher.MODE_ART, false,
    ...
    public void testBuildWithParameters () throws Exception{
      ...
      p.getPublishersList().add(getPerformancePublisher());
  ...
  protected PerformancePublisher getPerformancePublisher() {
    return new PerformancePublisher(0, 0, "",
            0, 0, 0, 0,
            PerformancePublisher.BUILD_MODE_LSB, null,
            50, false, PerformancePublisher.MODE_ART, false,
            asList(new JMeterParser("${JOB_NAME}/*.jtl")), false);
  }
  ...
  public void testBuildUnstableResponseThreshold() throws Exception {
        ...
        p.getPublishersList().add(
                new PerformancePublisher(0, 0, "test.jtl:100",
                    0, 0, 0, 0,
                    PerformancePublisher.BUILD_MODE_LSB, null,
                    0, true, PerformancePublisher.MODE_ART, false,
                    asList(new JMeterParser("**/*.jtl")), false));
    ...
    public void testBuildStableResponseThreshold() throws Exception {
        ...
        p.getPublishersList().add(
                new PerformancePublisher(0, 0, "test.jtl:5000",
                    0, 0, 0, 0,
                    PerformancePublisher.BUILD_MODE_LSB, null,
                    0, false, PerformancePublisher.MODE_ART, false,
                    asList(new JMeterParser("**/*.jtl")), false));
    ...
    public void buildUnstableAverageResponseTimeRelativeThreshold() throws Exception {
        ...
        p.getPublishersList().add(
                new PerformancePublisher(0, 0, null,
                    100.0d, 0, 50.0d, 0,
                    PerformancePublisher.BUILD_MODE_LSB, null,
                    0, false, PerformancePublisher.MODE_ART, true,
                    asList(new JUnitParser("**/*.xml")), false));
        // first build
        p.getBuildersList().add(new TestBuilder() {
            @Override
            public boolean perform(AbstractBuild<?, ?> build,
